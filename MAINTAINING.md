...
The `libpkgsource-plan/candidate-control/v1` digest is adapter-owned. Any change
to projected field participation, ordering, or digest framing requires an
explicit identity-version decision and fixed vectors. Do not use source origin,
