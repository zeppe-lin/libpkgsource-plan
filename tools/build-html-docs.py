...
DOCUMENTS = (
    ("README.md", "index.html", "libpkgsource-plan"),
    ...
    (
        ...
        "history/in-tree-adapter-migration.html",
        "In-tree adapter migration",
    ),
    (
        "docs/man/pkgsource_plan_adapter.3.md",
        "manual/pkgsource_plan_adapter.3.html",
        "pkgsource_plan_adapter(3)",
    ),
)
...
def navigation(page: Path, version: str) -> str:
    links = (
        ...
        ("ABI", "abi.html"),
        ("Manual", "manual/pkgsource_plan_adapter.3.html"),
        ("API", "api/index.html"),
...
def render_markdown(
    ...
    with tempfile.TemporaryDirectory(prefix="libpkgsource-plan-html-") as temp_name:
        temp = Path(temp_name)
